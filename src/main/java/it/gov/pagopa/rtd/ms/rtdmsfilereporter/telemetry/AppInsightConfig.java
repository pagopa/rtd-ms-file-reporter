...
import it.gov.pagopa.rtd.ms.rtdmsfilereporter.telemetry.AppInsightConfig.CustomRuntimeHints;
...
public class AppInsightConfig implements BeanPostProcessor {
  ...
  // There are some reflection data missing, this register the missing class.
